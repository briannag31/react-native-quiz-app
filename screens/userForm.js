...
const UserFormScreen = (props, {score}) => {
            ...
            <TouchableWithoutFeedback>
                <ScrollView>
                    ...
                    <View style={styles.buttonContainer}>
                        <View>
                            <TouchableOpacity title="Submit Details" onPress={handleSubmit} />
                        </View>
                        <View>
                            <TouchableOpacity title="Take Quiz" onPress={goTOQuiz} />
                        </View>
                    </View>
                    {/* {
